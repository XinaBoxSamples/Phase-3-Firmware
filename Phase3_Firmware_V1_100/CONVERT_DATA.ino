...
/*
    @brief, popoulates int32_t data type into buffer
            and checks whether ID occurs in any of the last 3 bytes
    @param data, unsigned 32 bit input
    @ret, none
*/
...
/*
    @brief, popoulates int8_t data type into buffer
            and checks whether ID occurs in the last
            byte
